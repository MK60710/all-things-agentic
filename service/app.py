...
from service.routers import chat, clarifications, gaps, health, papers, query, sessions
...
for router in (health.router, chat.router, query.router, clarifications.router, gaps.router, papers.router, sessions.router):
